...
const FAQSection = () => {
  ...
  return (
    <div className="flex items-center  text-white p-8">
      {/* Left Side with Heading */}
      <div className="w-[35%] flex items-start h-full pr-8">
        <Heading top="Solutions for Your Curiosities" med="IdeaTex" last="HELPDESK" />
      </div>

      {/* Right Side with FAQ */}
      <div className="w-[65%] h-[60vh] overflow-y-auto hide-scrollbar hide-scrollbar::-webkit-scrollbar space-y-4">
        {faqs.map((faq, index) => (
          <div
            key={index}
